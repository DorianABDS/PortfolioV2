...
export default function Navbar() {
    ...
    const navBaseMobile = "fixed bottom-0 left-0 right-0 z-50 bg-[#141414] sm:hidden";
    const navListBaseMobile = "flex flex-row text-white justify-around items-center relative";
    ...
    const navSizesDesktop = {
        sm: "sm:right-[20px] sm:px-0.5 sm:py-3",
    ...
    const navClassDesktop = `${navBaseDesktop} ${navSizesDesktop.sm} ${navSizesDesktop.md} ${navSizesDesktop.lg} ${navSizesDesktop.xl} ${navSizesDesktop["2xl"]}`;
    const navListClassDesktop = `${navListBaseDesktop} ${navListSizesDesktop.sm} ${navListSizesDesktop.md} ${navListSizesDesktop.lg} ${navListSizesDesktop.xl} ${navListSizesDesktop["2xl"]}`;
                ...
                <ul className={navListClassMobile}>
                    ...
                    <div
                        style={{
                            ...
                            height: '30px',
                            rotate: '270deg',
                            background: 'radial-gradient(circle at bottom right, transparent 30px, #141414 30px)'
                        }}
                    />
                    ...
                    <div
                        style={{
                            ...
                            height: '30px',
                            rotate: '90deg',
                            background: 'radial-gradient(circle at bottom left, transparent 30px, #141414 30px)'
                        }}
                    />
